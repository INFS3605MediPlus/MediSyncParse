        ...
        query.find({
            success: function(results) {
                for (var i=0;i < results.length; i++) {
                    var apptType = results[i];
                    $("#typeApptDropdown").append("<option value='" + apptType.id + "'>" + apptType.get('Appointment_Type') + "</option>");
                }
