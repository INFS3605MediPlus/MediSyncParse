...
commonFunction = function(){ 
    if (currentUser) {
        ...
        $("#patient-search-section").html("<h2 id='searchPatientHeading'>Search Patient</h2><p></p><form class='form-wrapper cf'><input type='text' placeholder='Search patient...'' required><button type='submit' id='search_patient_button'>Search</button></form>");
